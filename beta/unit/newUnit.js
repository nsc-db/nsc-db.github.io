...
$('#infographic-image').attr('src', '../../../common/assets/img/infographic/' + id + '.png');
...
for(var i in window.chara){
	if(id == window.chara[i]["cardId"]){
		...
		if(id == 60070401 || id == 60070501 || id == 60061201 || id == 60060701 || id == 60070601 || id == 60070901 || id == 60071001 || id == 60071201 || id == 60071211){
			tempId = id-1
		}
		else if(id == 60070402 || id == 60070502 || id == 60061202 || id == 60060702 || id == 60070602 || id == 60070902 || id == 60071002 || id == 60071202 || id == 60071212){
			tempId = id-2
		}
		else{
			tempId = id
		...
		if(charaBreakdown != ""){
			...
			$("#s2add2").text(parseInt(add2damages2).toLocaleString())
			$("#s2add2hit").text(s2add2hit)
			var tempdps, temps1a1, temps1a2, tempdsp2, temps2a1, temps2a2
			if(basedamage > 700000){
				tempdps = 700000
			}
			else{
				tempdps = basedamage
			}
			if(add1damage > 700000){
				temps1a1 = 700000
			}
			else{
				temps1a1 = add1damage
			}	
			if(add2damage > 700000){
				temps1a2 = 700000
			}
			else{
				temps1a2 = add2damage
			}	
			if(basedamages2 > 700000){
				tempdps2 = 700000
			}
			else{
				tempdps2 = basedamages2
			}
			if(add1damages2 > 700000){
				temps2a1 = 700000
			}
			else{
				temps2a1 = add1damages2
			}	
			if(add2damages2 > 700000){
				temps2a2 = 700000
			}
			else{
				temps2a2 = add2damages2
			}
			$("#s1ddl").text(parseInt(tempdps).toLocaleString())
			$("#s1add1dl").text(parseInt(temps1a1).toLocaleString())
			$("#s1add1hitdl").text(s1addhit)
			$("#s1add2dl").text(parseInt(temps1a2).toLocaleString())
			$("#s1add2hitdl").text(s1add2hit)

			$("#s2ddl").text(parseInt(tempdps2).toLocaleString())
			$("#s2add1dl").text(parseInt(temps2a1).toLocaleString())
			$("#s2add1hitdl").text(s2addhit)
			$("#s2add2dl").text(parseInt(temps2a2).toLocaleString())
			$("#s2add2hitdl").text(s2add2hit)
			...
			var s2addadvs2 = add2damages2
			var totaldamage = basedamage + (add1damage * s1addhit) + (add2damage * s1add2hit)
			var totaldamagedl = tempdps + (temps1a1 * s1addhit) + (temps1a2 * s1add2hit)
			var totaldamagedl2 = tempdps2 + (temps2a1 * s2addhit) + (temps2a2 * s2add2hit)
			$("#s1totaldl").text(parseInt(totaldamagedl).toLocaleString())
			$("#s1totaladvdl").text(parseInt(totaldamagedl).toLocaleString())
			$("#s2totaldl").text(parseInt(totaldamagedl2).toLocaleString())
			$("#s2advdl").text(parseInt(totaldamagedl2).toLocaleString())
			$("#s1pvpdl").text(parseInt(totaldamagedl).toLocaleString())
			$("#s1pvpadvdl").text(parseInt(totaldamagedl).toLocaleString())
			$("#s2pvpdl").text(parseInt(totaldamagedl2).toLocaleString())
			$("#s2pvpadvdl").text(parseInt(totaldamagedl2).toLocaleString())
			var totaldamages2 = basedamages2 + (add1damages2 * s2addhit) + (add2damages2 * s2add2hit)
			...
			if(legendary == 1){
				...
				document.getElementById("s1ladl").style.display = "";
				document.getElementById("s2ladl").style.display = "";

				var doubledamage = totaldamage * 2
				var penAdd = 1500000 * ((maxsd + 100) / 100) * 4
				var doubledamages2 = totaldamages2 * 2
				var penAdds2 = 1500000 * ((maxsd + 100) / 100) * 4
				
				$("#s1la").text(parseInt(doubledamage + penAdd).toLocaleString())
				$("#s2la").text(parseInt(doubledamage + penAdds2).toLocaleString())
				$("#s1ladl").text(parseInt(totaldamagedl + (700000*4)).toLocaleString())
				$("#s2ladl").text(parseInt(totaldamagedl2 + (700000*4)).toLocaleString())
			}
