...
function createPool(feature, six, ex, five, four){
	var length = 0;
	for(var n in window.tags){
		if(window.tags[n]['cardId'] == "20040303" || window.tags[n]['cardId'] == "20040304"){
			feature.push(window.tags[n]);
		}
		else if(window.tags[n]['cardId'] == '20031014'){
			six.push(window.tags[n]); 
		}
		else if(window.tags[n]['cardId'] == '20001678' || window.tags[n]['cardId'] == '20001813' 
			|| window.tags[n]['cardId'] == '20001857' || window.tags[n]['cardId'] == '20030505'
			|| window.tags[n]['cardId'] == '20001592' || window.tags[n]['cardId'] == '20030806'){
